    ...
    <div class="border-0 rounded-xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
      ...
      <form action="{{ route('login') }}" method="POST">
        ...
        <div class="relative p-6 flex-auto mx-10">
          <div class="mb-4">
            ...
            <input type="email" name="email" id="email" placeholder="name@domain.com"
              class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs" required autofocus />
        ...
        <div class="px-6 pb-6 rounded-b-xl mx-10">
          ...
          <button type="submit" class="bg-serv-button text-white text-lg py-3 px-12 my-2 rounded-lg w-full">
            Log in
          </button>

          <p href="#" class="text-center py-5">
            Dont have account?
            <a href="#" class="text-serv-button" onclick="toggleModal('loginModal');toggleModal('registerModal') ">
              Sign up
            </a>
          </p>
        </div>

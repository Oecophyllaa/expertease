    ...
    <div class="border-0 rounded-xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
      ...
      <div class="p-5 rounded-t-xl text-center mt-5 mx-10">
        <h3 class="text-2xl font-semibold">
          Sign up to ExpertEase
        </h3>
        <p class="text-gray-400 mt-1 text-sm">
          Join ExpertEase and start your real project
        </p>
      </div>
      ...
      <form action="{{ route('register') }}" method="POST">
        ...
        <div class="relative p-6 flex-auto mx-10">
          <div class="mb-4">
            ...
            <input type="text" name="name" id="name" placeholder="Your name"
              class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs" required />
            @if ($errors->has('name'))
          ...
          <div>
            ...
            <input type="password" name="password" id="password" placeholder="At least 8 characters"
              class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs mb-3" required />
          ...
          <div>
            ...
            <input type="password" name="password_confirmation" id="password_confirmation" placeholder="At least 8 characters"
              class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs mb-3" required />
          ...
          <div class="flex items-center justify-between">
            <div class="inline-block text-xs text-gray-400">
              <label class="inline-flex items-center mt-3">
                <input type="checkbox" class="form-checkbox h-5 w-5 text-serv-button rounded border-serv-text"><span class="ml-2 text-gray-400">I
                  agree to the <a href="#" class="text-serv-button">Terms & Conditions</a></span>
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="px-6 pb-6 rounded-b-xl mx-10">
          ...
          <p href="#" class="text-center py-5">
            Already have account? <a href="#" class="text-serv-button" onclick="toggleModal('loginModal');toggleModal('registerModal') ">Sign
              in</a>
          </p>
        </div>
      </form>

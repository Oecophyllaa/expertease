                ...
                <div class="px-4 py-5 sm:p-6">
                  <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="md:col-span-6 lg:col-span-3">
                      ...
                      <input placeholder="Enter your name here.." type="text" name="name" id="name" autocomplete="name"
                    ...
                    <div class="md:col-span-6 lg:col-span-3">
                      ...
                      <input placeholder="Enter your role here.." type="text" name="role" id="role" autocomplete="role"
                        class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                    ...
                    <div class="md:col-span-6 lg:col-span-3">
                      ...
                      <input placeholder="Enter your email here.." type="email" name="email" id="email" autocomplete="email"
                        class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                    ...
                    <div class="md:col-span-6 lg:col-span-3">
                      ...
                      <input placeholder="Enter your contact number here.." type="number" name="contact_number" id="contact_number"
                    ...
                    <div class="col-span-6">
                      ...
                      <textarea placeholder="Enter your biography here.." type="text" name="biography" id="biography" autocomplete="biography"
                        class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" rows="4">{{ $user->detail_user->biography ?? '' }}</textarea>
                    ...
                    <div class="col-span-6">
                      ...
                      @forelse ($experience_user as $key => $item)
                        <input placeholder="Enter your experience here.." type="text" name="{{ 'experience[' . $item->id . ']' }}"
                          id="{{ 'experience[' . $item->id . ']' }}" autocomplete="{{ 'experience[' . $item->id . ']' }}"
                          class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                        ...
                        @endif
                      @empty
                        <input placeholder="Enter your experience here.." type="text" name="experience[]" id="experience"
